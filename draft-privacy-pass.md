...
The `Init` function takes a length (or security) parameters, and an integer
description as input and outputs public auxiliary data in the form of an array
of bytes.

```go
func Init(secParameter uint16, description uint16) []byte
```
